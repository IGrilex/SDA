...
double durataDeTimp(int vector[],int numere)
{
    int copie[numere];
    ...
    bubbleS(copie,numere);

    copiere(vector,numere,copie);
    insertionS(copie,numere);

    copiere(vector,numere,copie);
    selectionS(copie,numere);

    copiere(vector,numere,copie);
    mergeS(copie,0,numere-1);

    copiere(vector,numere,copie);
    quickS(copie,0,numere-1);
...
void main()
{
    ...
    printf("\n\nLa primul vector a durat %f secunde sa sorteze vectorul in toate modurile de sortare\n",durataDeTimp(v1,numere));
    printf("\nLa al doilea vector a durat %f secunde sa sorteze vectorul in toate modurile de sortare\n",durataDeTimp(v2,numere));
    printf("\nLa al treilea vector a durat %f secunde sa sorteze vectorul in toate modurile de sortare\n",durataDeTimp(v3,numere));
}
